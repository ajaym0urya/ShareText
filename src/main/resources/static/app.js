...
const customLinkAlias = document.getElementById('customLinkAlias');
const generateRandomAliasBtn = document.getElementById('generateRandomAliasBtn');
...
// Generate random alias generator
generateRandomAliasBtn.addEventListener('click', () => {
